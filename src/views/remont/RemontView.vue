<template>
  <div class="container">
    ...
    <div align="center">
      <h1>Таблица </h1>
      <a href="/Create2View" class="btn btn-success m-2">Добавить</a>
    </div>
...
export default {
  ...
  methods: {
    ...
    async deleteproduct(id) {
      let result = await fetch("http://localhost:3000/remont/delete/"+ id, {
        method: "GET",
        headers: {
          accept: "application/json",
          "content-type": "application/json",          
    ...
    async getproductedit(id) {
      this.$router.push({ name: 'Edit2View', params: { id: id } });
    },
    async getproductdetels(id) {
      this.$router.push({ name: 'Detels2View', params: { id: id } });
    }
  },
